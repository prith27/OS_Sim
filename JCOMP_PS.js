...
function showOutput(flag) {
    ...
    gt.innerHTML = "";
    gt.setAttribute("style", "width: 802px; height: 100px; position: relative; margin: auto; border: .5px solid black;");
...
function drawChart() {
    ...
    for (var i = 0; i < gantt.length; i++) {
        ...
        if (gantt[i].id == -1) {
            d.textContent = "";
            d.setAttribute("style", "float:left;width:" + divWidth + "px; height:100px;background-color:black;");
        }
        else {
